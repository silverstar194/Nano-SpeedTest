...
This website, when launched, is able to time nano transactions from two nodes in disctint different places. In order to launch on your own computer, there are two disctinct setups: frontend and backend.
